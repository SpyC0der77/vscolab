"""Google Drive persistence + openvscode-server bootstrap for vscolab AI tier.
...
Pre-installs the Colab AI Language Model Chat Provider and starts the Colab AI bridge.
"""
